...
class Configurations {
  ...
  void setConfigurationValues(Map<String, dynamic> value) {
    ...
    _adConfig = value['adConfig'] != null
        ? ConfigurationUtils.loadAdConfig(value['adConfig'])
...
//-----------------------------
  ...
  void _loadConfig(String key) {
    switch (key) {
      case 'appConfig':
        _appConfig = _remoteConfig.getString(appConfig) ?? _appConfig;
        break;
      case 'serverConfig':
...
extension ConfigurationsFireBaseRemoteConfig on Configurations {
  Future<void> loadRemoteConfig() async {
    ...
    try {
      ...
      _listConfigRemoteKey.forEach(_loadConfig);
    } on FetchThrottledException catch (e) {
      printLog('Rmeote Config fetch throttled: $e');
    } catch (e) {
