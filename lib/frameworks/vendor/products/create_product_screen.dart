...
class _StateCreateProduct extends State<CreateProductScreen>
  ...
  void _createProduct() async {
    if (name.text.isEmpty) {
      Tools.showSnackBar(
          _scaffoldKey.currentState, 'Please enter the shirt listing title');
      return;
    }
    if (fileImages.isEmpty) {
      Tools.showSnackBar(
          _scaffoldKey.currentState, 'Please input the shirts pictures');
      return;
    }
    if (regularPrice.text.isEmpty) {
      Tools.showSnackBar(
          _scaffoldKey.currentState, 'Please enter the product price');
      return;
    }
