...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(day) => "${day} ڕۆژ پێش ئێستا";

  static m2(timeLeft) => "${timeLeft} تەواو دەبێت";

  static m3(message) => "هەڵە: ${message}";

  static m4(time) => "بەسەردەچێت لە ${time}";

  static m5(hour) => "${hour} کاتژمێر پێش ئێستا";

  static m6(message) => "کێشەیەک هەیە لەگەڵ سێرڤس لەکاتی داواکردنی داتا، تکایە پەیوەندی بکە بە سەرپەرشتیارەوى ئەپەکە بۆ چارەسەرکردنی کێشەکان: ${message}";

  static m7(minute) => "${minute} خولەك پێش ئێستا";

  static m8(itemCount) => "${itemCount} ئایتم";

  static m9(price) => "کۆى گشتى هەڵبژاردنەکان: ${price}";

  static m10(percent) => "داشکاندن ${percent} %";

  static m11(second) => "${second} چرکە پێش ئێستا";

  static m12(totalCartQuantity) => "سەبەتەى کڕین, ${totalCartQuantity} ئایتم";

  static m13(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static m14(total) => "${total} بەرهەمەکان";

  static m15(date) => "گونجاوە تا ${date}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "UserNameInCorrect" : MessageLookupByLibrary.simpleMessage("ناوى بەکارهێنەر، ووشەى تێپەڕ هەڵەیە"),
    ...
    "addToCart" : MessageLookupByLibrary.simpleMessage("زیادکردن بۆ سەبەتەى کڕین"),
    "addToCartSucessfully" : MessageLookupByLibrary.simpleMessage("زیادکرایە ناو سەبەتەى کڕینەکانت"),
    ...
    "cantFindThisOrderId" : MessageLookupByLibrary.simpleMessage("ئەم ژمارەى داواکارییە نەدۆزرایەوە"),
    ...
    "chooseFromGallery" : MessageLookupByLibrary.simpleMessage("هەڵبژاردن لە گەلەریەوە"),
    "chooseFromServer" : MessageLookupByLibrary.simpleMessage("هەڵبژاردن لە سێرڤەرەوە"),
    ...
    "clearCart" : MessageLookupByLibrary.simpleMessage("پاککردنەوەى سەبەتەى کڕین"),
    ...
    "countryIsRequired" : MessageLookupByLibrary.simpleMessage(" وڵات داواکراوە"),
    "couponCode" : MessageLookupByLibrary.simpleMessage("کۆپۆن کۆد"),
    "couponHasBeenSavedSuccessfully" : MessageLookupByLibrary.simpleMessage("کۆپۆن کۆد بەسەرکەوتووی تۆمارکرا"),
    ...
    "doYouWantToExitApp" : MessageLookupByLibrary.simpleMessage("دەتەوێت بەرنامەکە دابخەیتەوە بکەیت؟"),
    ...
    "editProductInfo" : MessageLookupByLibrary.simpleMessage("گۆڕانکارى کردن لە زانیارى بەرهەم"),
    "editWithoutColon" : MessageLookupByLibrary.simpleMessage("گۆڕانکارى"),
    "email" : MessageLookupByLibrary.simpleMessage("ئیمەیل"),
    "emailIsRequired" : MessageLookupByLibrary.simpleMessage(" ئیمەیل ئادرەس داواکراوە"),
    "emptyCartSubtitle" : MessageLookupByLibrary.simpleMessage("وادیارە تا ئێستا هیچ بڕگەیەکت بۆ سەبەتەى کڕینەکانت زیاد نەکردووە. دەست بکە بە بازاڕکردن بۆ پڕکردنەوەی."),
    "emptyUsername" : MessageLookupByLibrary.simpleMessage("ناوی بەکارهێنەر بەتاڵە"),
    "emptyWishlistSubtitle" : MessageLookupByLibrary.simpleMessage("کرتە لەسەر ئایکۆنى دڵ بکە ئێمە دڵخوازەکانت لێرە بۆ زیاد دەکەین"),
    "endsIn" : m2,
    ...
    "fileIsTooBig" : MessageLookupByLibrary.simpleMessage("قەبارەى ئەم فایلە زۆر گەورەیە، تکایە فایلێکى قەبارە کەم تر هەڵبژێرە"),
    "fileUploadFailed" : MessageLookupByLibrary.simpleMessage("بارکردنى فایل سەرکەوتوونەبوو!"),
    ...
    "fixedCartDiscount" : MessageLookupByLibrary.simpleMessage("داشکاندنى نرخى پوختە لە کارت"),
    "fixedProductDiscount" : MessageLookupByLibrary.simpleMessage("داشکاندنى نرخى پوختە لە بەرهەم"),
    ...
    "generalSetting" : MessageLookupByLibrary.simpleMessage("ڕێکخستنە گشتییەکان"),
    ...
    "getPasswordLink" : MessageLookupByLibrary.simpleMessage("بەدەستهێنانی لینکی تێپەڕە ووشە"),
    "goBackHomePage" : MessageLookupByLibrary.simpleMessage("بگەڕێوە لاپەڕەی سەرەکی"),
    ...
    "lastNameIsRequired" : MessageLookupByLibrary.simpleMessage(" ناوی باوك داواکراوە"),
    ...
    "mustSelectOneItem" : MessageLookupByLibrary.simpleMessage("پێویستە ١ ئایتم هەڵبژێریت"),
    ...
    "noBlog" : MessageLookupByLibrary.simpleMessage("هیچ بڵاوکراوەیەک بەردەست نیە"),
    ...
    "orderSuccessMsg2" : MessageLookupByLibrary.simpleMessage("دەتوانیت داخڵى هەژمارەکەت ببیت بە بەکارهێنانی ئیمەیڵ و تێپەڕوشە کە پێشتر پێناسە کراوە. لەسەر هەژمارەکەت. دەتوانیت زانیاری پرۆفایلەکەت بژار بکەیت، مێژووی مامەڵەکان بپشکنە، بەشداریکردن لە هەواڵنامە بژار بکەیت."),
    "orderSuccessTitle1" : MessageLookupByLibrary.simpleMessage("داواکردنەکەت بەسەرکەوتوویی نێردرا "),
    ...
    "phoneIsRequired" : MessageLookupByLibrary.simpleMessage(" ژمارە تەلەفۆن داواکراوە"),
    ...
    "pleaseSelectRequiredOptions" : MessageLookupByLibrary.simpleMessage("تکایە هەڵبژاردنە پێویستەکان دیارى بکە!"),
    ...
    "pointRewardMessage" : MessageLookupByLibrary.simpleMessage("یاسای داشکاندن هەیە بۆ جێبەجێکردنی خاڵەکانت بۆ سەبەتەى کڕین"),
    ...
    "rateTheApp" : MessageLookupByLibrary.simpleMessage("هەڵسەنگاندنى ئەپڵیکەشن"),
    ...
    "reviewApproval" : MessageLookupByLibrary.simpleMessage("پێداچوونەوە ى پەسەندکردن"),
    "reviewPendingApproval" : MessageLookupByLibrary.simpleMessage("هەڵسەنگاندنەکەت بەسەرکەوتووی نێردرا و لە چاوەڕوانى پەسەندکردندایە!"),
    "reviewSent" : MessageLookupByLibrary.simpleMessage("هەڵسەنگاندنەکەت بەسەرکەوتووی نێردرا!"),
    ...
    "searchOrderId" : MessageLookupByLibrary.simpleMessage("بگەڕێ بۆ ژمارەى داواکارى..."),
    ...
    "selectFileCancelled" : MessageLookupByLibrary.simpleMessage("فایلى هەڵبژێردراو پوچەڵ کرایەوە!"),
    ...
    "shortDescription" : MessageLookupByLibrary.simpleMessage("پوختەى ڕوونکردنەوە"),
    "showAllMyOrdered" : MessageLookupByLibrary.simpleMessage("هەموو داواکردنەکانم پێشان بدە"),
    "showDetails" : MessageLookupByLibrary.simpleMessage("پیشاندانى وردەکارییەکان"),
    ...
    "stateIsRequired" : MessageLookupByLibrary.simpleMessage(" پارێزگا داواکراوە"),
    ...
    "streetIsRequired" : MessageLookupByLibrary.simpleMessage(" ناونیشان داواکراوە"),
    ...
    "thisFeatureDoesNotSupportTheCurrentLanguage" : MessageLookupByLibrary.simpleMessage("ئەم تایبەتمەندییە پشتگیری ئەم زمانە ناکات"),
    ...
    "typeYourMessage" : MessageLookupByLibrary.simpleMessage("پەیامەکەت لێرە بنووسە..."),
    ...
    "updateInfo" : MessageLookupByLibrary.simpleMessage("نوێکردنەوى زانیارییەکان"),
    ...
    "womanCollections" : MessageLookupByLibrary.simpleMessage("کۆڵێکشنی ئافرەتان"),
    ...
    "yourBagIsEmpty" : MessageLookupByLibrary.simpleMessage("سەبەتەى کڕینەکانت بەتاڵە"),
    "yourEarningsThisMonth" : MessageLookupByLibrary.simpleMessage("پەیداکردنەکانت لەم مانگەدا"),
    ...
    "zipCodeIsRequired" : MessageLookupByLibrary.simpleMessage(" کۆدی پۆستە داواکراوە")
  };
}
