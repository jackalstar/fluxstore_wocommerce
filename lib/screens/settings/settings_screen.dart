      ...
      case 'requestshirt':
        {
          ...
          title = 'Request a shirt';  //replace your title here
          trailing =
          ...
          onTap = () => Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) => WebView(
                    url: 'https://www.yourfootballshirt.com/en/request-a-shirt/',  //replace your url here
                    title: 'Request a shirt'),  //replace your title here
              ));
          break;
        }
        ...
        {
          icon = CupertinoIcons.info;
          title = 'Authentify my shirt';  //replace your title here
          trailing =
          const Icon(Icons.arrow_forward_ios, size: 18, color: kGrey600);
          onTap = () => Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => WebView(
                    url: 'https://www.yourfootballshirt.com/en/authentifier-mobile/',  //replace your url here
                    title: 'Authentify my shirt'),  //replace your title here
              ));
          break;
        }
...
//          }
      ...
      case 'about':
        {
          icon = CupertinoIcons.info;
          title = 'About YFS';  //replace your title here
          trailing =
          const Icon(Icons.arrow_forward_ios, size: 18, color: kGrey600);
          onTap = () => Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => PostScreen(
                    pageId: 14,  //replace your url here
                    pageTitle: 'About YFS'),  //replace your title here
              ));
          break;
        }
      default:
