...
class _StateBannerSlider extends State<BannerSliderItems> {
  ...
  Widget getBannerPageView(width) {
    ...
    var boxFit = Tools.boxFit(widget.config['fit'] ?? 'cover');
        ...
        return FractionallySizedBox(
          ...
          child: Container(
            margin: EdgeInsets.only(
              left: Tools.formatDouble(widget.config['marginLeft'] ?? 0.0),
              right: Tools.formatDouble(widget.config['marginRight'] ?? 0.0),
              top: Tools.formatDouble(widget.config['marginTop'] ?? 0.0),
              bottom: Tools.formatDouble(widget.config['marginBottom'] ?? 0.0),
            ),
            child: Stack(
              children: <Widget>[
